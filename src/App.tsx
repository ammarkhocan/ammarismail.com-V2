    ...
    <main className="min-h-screen font-sans bg-background text-foreground transition-colors duration-300">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-14 pt-24 md:px-8">
        <div className="mb-10 grid gap-10 md:grid-cols-2 md:items-center">
          <div className="flex justify-center md:justify-start">
            <div className="relative h-56 w-56 md:h-72 md:w-72">
              ...
              <div className="bg-linear-to-br absolute -inset-2 rounded-full from-foreground/10 to-transparent opacity-60 blur-xl" />

              <img
                src="https://17worsb7dw.ucarecd.net/cea206be-5cd8-4fcf-9853-abb4f99318ff/-/preview/971x1000"
                alt="Ammar"
                loading="lazy"
                className="relative h-full w-full rounded-full border border-border object-cover shadow-[0_18px_50px_rgba(0,0,0,0.15)] dark:shadow-[0_18px_50px_rgba(0,0,0,0.55)]"
                onError={(e) => {
          ...
          <div className="min-w-0">
            ...
            <h1 className="leading-[1.1] tracking-tight text-4xl font-extrabold md:text-6xl">
              ...
              <span className="bg-linear-to-r bg-clip-text text-transparent from-foreground via-foreground/70 to-foreground/50">
                Ammar
              </span>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <Button asChild className="group rounded-full px-6 font-medium">
        ...
        <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          ...
          <Button
            variant="outline"
            className="group whitespace-nowrap rounded-full bg-transparent"
            asChild
          >
            <Link to="/projects" className="gap-2">
              View All{" "}
        ...
        <div className="bg-linear-to-br group relative mt-20 flex flex-col overflow-hidden rounded-3xl border border-border from-muted/50 to-transparent p-8 gap-6 md:flex-row md:items-center md:justify-between md:p-12">
          <div className="absolute right-0 top-0 -mr-10 -mt-10 h-40 w-40 rounded-full bg-foreground/5 blur-3xl transition-all duration-700 group-hover:bg-foreground/10"></div>
          ...
          <Button
            asChild
            className="relative z-10 group w-full rounded-full px-8 py-6 text-base md:w-auto"
          >
